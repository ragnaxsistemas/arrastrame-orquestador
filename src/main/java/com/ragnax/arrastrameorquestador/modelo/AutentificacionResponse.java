...
public class AutentificacionResponse implements Serializable{
	...
	public AutentificacionResponse() {
		super();
	}
	
	public AutentificacionResponse(boolean valido) {
		super();
	
	}
	
	public AutentificacionResponse(BasicContext basicContext) {
		super();
		this.basicContext = basicContext;
	}
	
	public AutentificacionResponse(EnterpriseContext enterpriseContext) {
		super();
		this.enterpriseContext = enterpriseContext;
	}
	
	public AutentificacionResponse(AutentificacionContext autentificacionContext) {
		super();
